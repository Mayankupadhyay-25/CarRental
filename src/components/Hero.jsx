...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justyfy-center gap-14 bg-light text-center'>
        ...
        <h1 className='text-4xl md:text-5xl font-semibold mt-15'>Luxury cars on Rent</h1>
        ...
        w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rbg(0,0,0,0,1)]'>
            ...
            <div className='flex flex-col md:flex-row items:start md:items-center gap-10 min-md\:ml-8'>
             ...
             <button className='flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary-dull
