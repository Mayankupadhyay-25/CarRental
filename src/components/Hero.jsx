...
const Hero = () => {
  ...
  return (
    ...
    className="h-screen flex flex-col items-center justyfy-center gap-14 bg-light text-center">

      <motion.h1 
       initial = {{y: 50, opacity: 0}}
       animate = {{y: 0, opacity: 1}}
       transition = {{duration : 0.8, delay: 0.2}}
      className="text-4xl md:text-5xl font-semibold mt-15">
        Luxury cars on Rent
      </motion.h1>
      ...
      >
        ...
        whileTap={{scale: 0.95}}
          className="flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary-dull
                text-white rounded-full coursor-pointer"
        >
          <img
