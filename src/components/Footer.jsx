            ...
            <div className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-'>
                <div className=''>
                    ...
                    <p className='max-w-80 mt-3'>
                        Premium car service with a wide selection of luxury and everyday vehicals for all your driving needs.
                    </p>
                ...
                <div>
                 ...
                 <div>
                    <h2 className='text-base font-medium text-gray-800 uppercase'>Contect</h2>
                    <ul className='mt-3 flex flex-col gap-1.5 '>
