...
const ManageCars = () => {
  ...
  const  fetchOwnerCars = async () => {
    ...
    setCars(dummyCarData.map(car => ({...car, isAvailable: true})))
  }
  useEffect(( ) => {
    fetchOwnerCars()
  }, [])
  return (
     <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle= " View all listed cars, update their details or remove them from the bookng platform"/>
